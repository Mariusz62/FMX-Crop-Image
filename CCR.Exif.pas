...
uses
  ...
  {$IFDEF VCL}VCL.Graphics, VCL.Imaging.jpeg,{$ENDIF}{$IFDEF FMX}FMX.Graphics, FMX.Types,{$ENDIF}
...
type
{$IFDEF FMX}
  TGraphic = FMX.Graphics.TBitmap;//FMX.Types.TBitmap;

  TJPEGImage = class(FMX.Graphics.TBitmap, IStreamPersist)
  public
